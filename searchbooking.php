...
<body>
    ...
    if(isset($_POST['book'])){
        ...
        if($conflict){
                ...
                ?>
                <h4 class = "ml-4 mt-3">Order Summary</h4>
                <form method = "post" class="mt-3 ml-4 mb-1" style="max-width: 60%">
                    ...
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-label">Field Number</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control-plaintext" id="inputPassword" value=": <?php echo $start_time.'.00 - '.$end_time.'.00';?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            for($x=0;$x<$duration;$x++){
                                if($price_count+1>=8 && $price_count<14){
                                    ...
                                    if($field==1 || $field==3){
                                        if (($day_num>=1 && $day_num<=3)||$day_num=7){
                                            $price = $price + 125000;
                                        }else{
                                            $price = $price + 150000;   
                                        }
                            ...
                            ?>
                            <input type="text" readonly class="form-control-plaintext font-weight-bold" id="inputPassword" value=": Rp. <?php echo $price;?>,00">
                        </div> 
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-10">
